...
let invoke = function(req,res){
  ...
  if(!handler){
    ...
    responses.serveStaticFile(req,res);
    return;
  }
  handler(req,res);
}
...
const bindWithResponse = function(){
  this.redirect = responses.redirect;
  this.resourceFoundHandler = responses.resourceFoundHandler;
  this.resourceNotFoundHandler = responses.resourceNotFoundHandler;
}
